...
/// <summary>
/// One search result plus the logical columns in which a positive search term
/// was found. Column names are independent of the current UI visibility.
/// </summary>
public sealed record ViCoWorkstationSearchHit(
