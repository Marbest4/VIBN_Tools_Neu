...
4. Einen Root anhand Name, GUID und Quelle auswählen. Auch bei `FEE-Struktur (rekonstruiert)` werden Containeranzahl, Signalanzahl und Prüfhinweise bereits beim Einlesen ermittelt.
